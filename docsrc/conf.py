...
project = pyblast.__title__
copyright = "2017-2019, University of Washington"
author = ', '.join(pyblast.__authors__)
...
version = pyblast.__version__
gitpage = pyblast.__homepage__
# The full version, including alpha/beta/rc tags.
release = pyblast.__version__
...
html_context = {
    "version": version,
    "github": pyblast.__homepage__,
    "repo": pyblast.__repo__,
    "display_github": True,  # Integrate GitHub
    "github_user": "jvrana",  # Username
    "github_repo": "pyblast",  # Repo name
...
html_theme_options = {
    ...
    "navbar_title": "pyblast",
    "navbar_site_name": "pyblast",
...
man_pages = [(master_doc, "pyblast", "pyblast Documentation", [author], 1)]
